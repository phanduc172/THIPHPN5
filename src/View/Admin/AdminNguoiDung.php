...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Navbar Search-->
        <form action="../../Controller/NguoiDungController.php" method="post" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <div class="input-group">
                <input name="txttkiem" class="form-control" type="text" placeholder="Tìm kiếm..." aria-label="Search for..." aria-describedby="btnNavbarSearch" />
